    ...
    <div class="main-content">
        <div class="container py-5">
            <div class="d-flex justify-content-between align-items-center mb-5 animate-up">
                <h2 class="fw-bold m-0 text-primary">Ride On - <span><?= htmlspecialchars($typeFilter) ?>s</span></h2>
            </div>
            ...
            <div class="glass p-4 rounded-4 mb-5 animate-up" style="animation-delay: 0.1s;">
                <form class="row g-3" method="GET">
                    <div class="col-md-3">
                        <label class="form-label small fw-bold text-muted">Bike Type</label>
                        <select name="bike_type" class="form-select border-0 bg-light">
                            <option value="all">All Models</option>
                            <?php foreach ($bikeTypes as $b): ?>
                                <option value="<?= htmlspecialchars($b['vehicle_model']) ?>"
                                    <?= $bikeType == $b['vehicle_model'] ? 'selected' : '' ?>>
                            ...
                            <div class="card h-100 border-0 shadow-sm rounded-4 overflow-hidden vehicle-card-modern">
                                ...
                                <div class="card-body p-4">
                                    ...
                                    <div class="d-flex align-items-center mb-4 text-muted small">
                                        ...
                                        <span><i class="fas fa-motorcycle me-1 text-primary"></i> Bike</span>
                                    </div>
                ...
                <?php else: ?>
                    <div class="col-12 text-center py-5">
                        <div class="glass p-5 rounded-4">
                            ...
                            <h4 class="text-muted">No bikes found</h4>
