        ...
        <div class="container py-5">
            ...
            <div class="glass p-4 rounded-4 mb-5 animate-up" style="animation-delay: 0.1s;">
                <form class="row g-3" method="GET">
                    <div class="col-md-3">
                        <label class="form-label small fw-bold text-muted">Bus Type</label>
                        <select name="bus_type" class="form-select border-0 bg-light">
                            <option value="all">All Models</option>
                            <?php foreach ($busTypes as $b): ?>
                                <option value="<?= htmlspecialchars($b['vehicle_model']) ?>"
                                    <?= $busType == $b['vehicle_model'] ? 'selected' : '' ?>>
                                ...
                                <div class="card-body p-4">
                                    ...
                                    <div class="d-flex align-items-center mb-4 text-muted small">
                                        ...
                                        <span><i class="fas fa-users me-1 text-primary"></i>
                                            <?= htmlspecialchars($vehicle['seats']) ?> Seats</span>
                                    </div>
